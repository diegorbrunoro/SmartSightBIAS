...
def compras_dados_download_farm(request):
    print("Iniciando execução da função compras_dados_download_farm.")
    ...
    modulo = 'compra'  # Correto pra compras
    max_paginas = 1000
    ...
    while True:
        ...
        if iteracao >= max_paginas:
            ...
            requests.post(consolidate_url, json={
                "module": "compra",
                "output_file": "compra/consolidado/compras_inicial.parquet"
            })
        ...
        if (iteracao - iteracao_inicial) >= max_iteracoes_por_execucao:
            ...
            reinvoke_url = "https://southamerica-east1-quick-woodland-453702-g2.cloudfunctions.net/compras-dados-download-farm"
...
if __name__ == "__main__":
    ...
    try:
        functions_framework.run_http(compras_dados_download_farm, host="0.0.0.0", port=port)
