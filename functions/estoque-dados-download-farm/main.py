...
def estoque_dados_download_farm(request):
    print("Iniciando execução da função estoque_dados_download_farm.")
    ...
    modulo = 'estoque'  # Alterado para estoque
    max_paginas = 1000
    ...
    while True:
        ...
        if iteracao >= max_paginas:
            ...
            requests.post(consolidate_url, json={
                "module": "estoque",
                "output_file": "estoque/consolidado/estoque_inicial.parquet"
            })
        ...
        if (iteracao - iteracao_inicial) >= max_iteracoes_por_execucao:
            ...
            reinvoke_url = "https://southamerica-east1-quick-woodland-453702-g2.cloudfunctions.net/estoque-dados-download-farm"
...
if __name__ == "__main__":
    ...
    try:
        functions_framework.run_http(estoque_dados_download_farm, host="0.0.0.0", port=port)
